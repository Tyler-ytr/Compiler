...
{
       0,   121,   121,   127,   130,   134,   138,   142,   146,   150,
     156,   161,   165,   169,   173,   177,   181,   186,   190,   194,
     198,   202,   206,   210,   215,   219,   224,   228,   232,   236,
     240,   244,   248,   253,   257,   260,   265,   270,   274,   279,
     285,   290,   295,   300,   305,   310,   315,   320,   325,   330,
     335,   340,   344,   349,   354,   359,   364,   369,   374,   379
};
#endif
...
#line 194 "./syntax.y" /* yacc.c:1646  */
    {
                    (yyval.node)=add_bisonnode("FuncDec",(yyloc).first_line);
                                add_parentnode((yyval.node),4,(yyvsp[-3].node),(yyvsp[-2].node),(yyvsp[-1].node),(yyvsp[0].node));
}
